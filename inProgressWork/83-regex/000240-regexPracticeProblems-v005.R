# The following websites have some regex practice problems
#
...
# QUESTION
#
# Use regular expressions to show only those pepole that have a first,middle and last
# name. 
...
# Show the first 200 lines of the book.
...
# - replace the  "é" "è" symbols with the text "e"
...
head(sherlock, 200)    # see which lines precede the text of the book
sherlock2 = sherlock[-(1:53)]   # remove those lines
head(sherlock2, 30)

# Analyze the last lines of the text. You can see from this output that 
...
# QUESTION  (NEW - ADDED TO v005 OF THIS FILE)
#
...
# We can prove that the entire book is in a single character value. The length
...
# NEW - ADDED TO v005 OF THIS FILE
...
#############################################################
# Other sample problems ... need to be edited and fixed
#############################################################


#product in commentsProduct and good great fantastic
Product and NOT bad terrible junk
#review by personProduct and good words and bad words
...
#DatesConvert do column to standard format
???Find dates with 2 digit year





#part nums B w g yJan feb mar.  J f m a y u l g s o nMTWHFSU.  DayL m s x
Year.    A b c d e f g h I j k l m n o p q r s t 
New York    Florida.  California
Reformat to different coding
Reformat to different order 

Find codes where 4 digit vs other lengths



Mislabeled info ... change itExtra info




# screen scraping Pre formatted info inside 




# read lines of book. Make into vector of sentences.


Table ofMisspelled words




Vscode files with patterns- dates
