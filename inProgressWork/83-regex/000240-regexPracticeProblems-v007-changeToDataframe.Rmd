...
```{r, q11-results, class.source="yrResults", echo=FALSE}
...
# Show the last lines 500 of the text. You can see from this output that 
...
```{r, q12-results, class.source="yrResults", echo=FALSE}
tail(sherlock2, 500)
```
