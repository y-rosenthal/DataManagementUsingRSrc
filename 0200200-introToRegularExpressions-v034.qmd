# <yrChapterNumber></yrChapterNumber> Intro to Regular Expressions (regex)
...
str_length(c("abc", "hello", "I like ice cream!"))  # 3 5 16
stringr::str_length(c("abc", "hello", "I like ice cream!"))  # 3 5 16
