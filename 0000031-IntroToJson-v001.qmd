...
Intro to JSON files
  ...
  * [Download 000200-IntroToJSONDataFormat-v008.docx](./000200-IntroToJSONDataFormat-v008.docx){download="000200-IntroToJSONDataFormat-v008.docx"}

The jsonlite R pacakge - Reading JSON files into R

  * <https://cran.r-project.org/web/packages/jsonlite/vignettes/json-aaquickstart.html>{target=_blank}
  * This is the link to the CRAN webpage for the jsonlite package. 
...
``` 
 ...
 ### EXAMPLE 2 - JSON data describing books for sale on a website
