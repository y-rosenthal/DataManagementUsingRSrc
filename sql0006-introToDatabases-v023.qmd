...
```{mermaid}
flowchart LR
    U[Student using browser/app] -->|1. Search or Enroll request| W[Web server program]
    W -->|2. SQL query| D[Database server program (DBMS)]
    D -->|3. Results / update status| W
    W -->|4. HTML or JSON response| U

    D --> S[(Database storage:\nCourses, Sections, Seats,\nStudents, Enrollments)]
    S --> D
```
