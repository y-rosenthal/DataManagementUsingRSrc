...
1. **Document Stores**  *(mentioned above)*
...
2. **Graph Databases**  *(mentioned above)*
   - Store relationships between data points as graphs (nodes and edges).  
   - Ideal for social networks, fraud detection, and recommendation systems.  
   - **Examples:** Neo4j, ArangoDB, Amazon Neptune3. **Key-Value Stores**  
