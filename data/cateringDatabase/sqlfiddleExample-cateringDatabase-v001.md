...
#   sqlfiddle.com
#   
#   You can use this website to try different flavors of sql.
...
#   ------------------------------------------------------------------------
#   
#   EXAMPLE - click on the following URL:    http://sqlfiddle.com/#!17/8efb57/8
#   
#   To see the following database tables and sample data running in the sqlfiddle.com website.
#   
#   +---------------------+           +----------------------+
#   |  venues             |           |  parties             |
#   +---------------------+           +----------------------+
...
#   
#   
#   **The LEFT side of the SQLFiddle.com webpage is populated with the following code**
#   
...
#   
#   -- we can use the delete command here too to the delete the row we just added
#   delete from parties
#   where partyid = 'p99';
#   
#   
...
#   
#   
#   **The right side of the SQLFiddle.com webpage is populated with the following code**
#   
#   select parties.partyId, venueName, cuisine, 
#          customerFirstName || ' ' || customerLastName as customer, 
#          count(*) as numWaiters
#   from venues join parties on venues.venueId = parties.venueId
#               join parties_waiters on parties.partyId = parties_waiters.partyId
#   group by parties.partyId, venueName, cuisine, customerFirstName, customerLastName
#   order by partyId;
#   
#   select * from parties;  
#   
