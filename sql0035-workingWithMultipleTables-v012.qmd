...
##### customers table - click here to expand/collapse
```{r}
# The following query shows exactly how many rows there are in this table
sqldf("select count(*) from customers order by CustomerId limit 10")

# These are just the first 10 rows from the customers table ...
sqldf("select * from customers order by CustomerId limit 10")
```
:::

::: {.callout-note collapse="false"}
##### orders table - click here to expand/collapse
```{r}
# The following query shows exactly how many rows there are in this table
sqldf("select count(*) from orders order by CustomerId limit 10")

# These are just the first 10 rows from the orders table ...
...
##### click here to see the ENTIRE orders table
```{r}
...
Show how customers map to orders

```{r}
# Show customer info for customer id 10,11 and 12

sqldf("select * 
       from customers 
       where CustomerId in (10,11,12)
       order by CustomerId")


# Show all orders for customer id 10, 11 and 12 
...
#
# Only show data for all orders placed by customers 10, 11, 12

sqldf("select OrderID, customers.CustomerId, CustomerName, Country, OrderDate
       from orders join customers on orders.customerId = customers.CustomerId
       where customers.CustomerId in (10,11,12)")   # same result if you say orders.customerId
