# <yrChapterNumber>30. </yrChapterNumber> Intro to Relational Databases and SQL ***(no dplyr required)***
...
You can download the data for the work on this page below. This file
is a sqlite database file.


## What software do I need to use SQL?

There are many different software packages that can be used to 
learn SQL. These different packages each have a learning curve of their own
beyond the raw SQL language. Our focus is to study the SQL language.
The following are just two of many, many options.

### yrSqliteViewer 

This is an extremely simple option for getting to work with SQL without much
fuss. This option makes use of SQLite database files.

The yrSqliteViewer.html file is a webpage that is installed locally on your
computer. You can download it from here. You can also download some sample
data from the same page.
Scroll to the bottom of this page for instructions.

<https://github.com/y-rosenthal/yrSqliteViewer>

### Running SQL commands from the R programming language
...
# 
# You can use the R programming language to process SQL commands.
...
file.copy(from="data/sqlbolt_tables.sqlite", to=".")
```

You can download the data for this tutorial from the following files.

### Use this one file if you're using yrSqliteViewer to access the data

- [sqlbolt_tables.sqlite](sqlbolt_tables.sqlite)
  

### Use these files if you're using R to access the data
...
## R users: How to use the R sqldf() function
...
## R users: capturing the output of sqldf in an R variable
...
## R users: A note about case-sensitivity in sqldf()
...
## R Users: Rules for naming tables and columns
...
## R users: Reminder - how NA works in R
...
## R Users: dynamic SQL - a brief introduction
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function getBlocks(section) {
    return section.querySelectorAll("details");
  }

  function expandAll(section) {
    getBlocks(section).forEach(d => d.open = true);
  }

  function collapseAll(section) {
    getBlocks(section).forEach(d => d.open = false);
  }

  document.querySelectorAll("section").forEach(section => {
    const hasDetails = section.querySelector("details");
    if (!hasDetails) return;

    const btnWrap = document.createElement("div");
    btnWrap.style.margin = "0.5em 0";

    const expandBtn = document.createElement("button");
    expandBtn.textContent = "Expand all";
    expandBtn.className = "btn btn-sm btn-outline-primary";
    expandBtn.style.marginRight = "0.5em";

    const collapseBtn = document.createElement("button");
    collapseBtn.textContent = "Collapse all";
    collapseBtn.className = "btn btn-sm btn-outline-secondary";

    expandBtn.onclick = () => expandAll(section);
    collapseBtn.onclick = () => collapseAll(section);
    ...
    if (header) {
      header.insertAdjacentElement("afterend", btnWrap);
    }
  });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function getBlocks(section) {
    return section.querySelectorAll(".collapse");
  }

  function expandAll(section) {
    getBlocks(section).forEach(el => {
  ...
  document.querySelectorAll("section").forEach(section => {
    const hasBlocks = section.querySelector(".collapse");
    if (!hasBlocks) return;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function expandAll(section) {
    getBlocks(section).forEach(el => el.classList.add("show"));
  }

  function collapseAll(section) {
    getBlocks(section).forEach(el => el.classList.remove("show"));
  }

  document.querySelectorAll('[data-bs-toggle="collapse"]').forEach(toggle => {

    if (toggle.querySelector(".quarto-expand-controls")) return;

    const wrapper = document.createElement("span");
    wrapper.className = "quarto-expand-controls";
    ...
    expandBtn.addEventListener("click", function (e) {
      e.stopPropagation();
      expandAll(getSection(toggle));
    });

    collapseBtn.addEventListener("click", function (e) {
      e.stopPropagation();
      collapseAll(getSection(toggle));
    });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll('[data-bs-toggle="collapse"]').forEach(toggle => {
    ...
    function handleClick(e, action) {
      e.preventDefault();      // 🔑 stops Bootstrap toggle
    ...
    expandBtn.addEventListener("click", (e) => handleClick(e, expandAll));
    collapseBtn.addEventListener("click", (e) => handleClick(e, collapseAll));
