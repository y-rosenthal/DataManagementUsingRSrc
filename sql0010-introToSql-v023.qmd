...
## Note for R users: How to use the R sqldf() function
...
## Note for R users: capturing the output of sqldf in an R variable
...
## Note for R users: A note about case-sensitivity in sqldf()
...
## Note for R users: Reminder - how NA works in R
