# <yrChapterNumber></yrChapterNumber> Contents {#contents .TOC-Heading}

[WHAT IS A COMMAND LINE INTERFACE (CLI)?
[1](#what-is-a-command-line-interface-cli)](#what-is-a-command-line-interface-cli)

[WHY SHOULD I CARE ABOUT A CLI ?
[1](#why-should-i-care-about-a-cli)](#why-should-i-care-about-a-cli)

[DIFFERENT CLIs FOR DIFFERENT COMPUTER SYSTEMS
[2](#different-clis-for-different-computer-systems)](#different-clis-for-different-computer-systems)

[What is the \"Bash Shell\" program?
[2](#what-is-the-bash-shell-program)](#what-is-the-bash-shell-program)

[How to use Bash in RStudio\'s \"Terminal\" window
[3](#how-to-use-bash-in-rstudios-terminal-window)](#how-to-use-bash-in-rstudios-terminal-window)

[The short answer: [3](#the-short-answer)](#the-short-answer)

[Problems running Bash in RStudio? Try changing some options in RStudio.
[3](#problems-running-bash-in-rstudio-try-changing-some-options-in-rstudio.)](#problems-running-bash-in-rstudio-try-changing-some-options-in-rstudio.)

[What is the Bash \"prompt\" ?
[4](#what-is-the-bash-prompt)](#what-is-the-bash-prompt)

[How to change the Bash prompt
[5](#how-to-change-the-bash-prompt)](#how-to-change-the-bash-prompt)

[How can I confirm that I\'m using the \"Bash\" Command Line Interface
program?
[5](#how-can-i-confirm-that-im-using-the-bash-command-line-interface-program)](#how-can-i-confirm-that-im-using-the-bash-command-line-interface-program)

[\"Bash commands\" or \"Linux commands\" ?
[6](#bash-commands-or-linux-commands)](#bash-commands-or-linux-commands)
...
-   **[Reason 1:]{.underline}** A CLI allows you to do powerful things
    quickly. Many of the CLI commands can be quite powerful and can cut
...
-   **[Reason 2:]{.underline}** You can create \"scripts\" to automate
    many things. Suppose your boss told you that everyone in the company
...
-   **[Reason 3:]{.underline}** Many basic concepts from the command
...
-   **[Reason 4:]{.underline}** Technology and data professionals are
    often expected to understand at least the basics of using a CLI.
...
-   Mac\
    ...
    the Mac. The terminal program actually allows
...
-   Windows\
    ...
    -   **Bash:** You can also download a version of the \"Bash Shell\"
        CLI program that will work under Windows. See below for more
        info about Bash.
...
CLI commands), similar to the way you must \"go through the shell\" to
get to the inside of an egg.*
...
used on Windows. Some of these are:

-   git bash - In my opinion (in 2023) for someone who just want to
    learn the basics of Bash, this is the easiest option to try. The
    other options may be a little more work to install. To install this
...
You can type Command Line Interface (CLI) commands directly in RStudio.
To do so, choose the following menu choices to open the Terminal tab:
***Tools menu \> Terminal \> Move Focus to Terminal***

Some versions of Mac and all versions of Windows come with different CLI
programs. To use the Bash CLI, choose Bash from the following menu (this
...
![](media/image1.png){width="2.387470472440945in"
height="3.425209973753281in"} ![Graphical user interface, text,
application Description automatically
generated](media/image2.png){width="3.252548118985127in"
height="3.3861843832021in"}
...
*** ![](media/image3.png){width="2.4381944444444446in"
...
> generated](media/image4.png){width="3.683333333333333in"
...
![](media/image5.png){width="1.2805555555555554in"
