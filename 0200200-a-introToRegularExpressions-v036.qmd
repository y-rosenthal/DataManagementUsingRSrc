# <yrChapterNumber>23. </yrChapterNumber> regular expressions (regex)
...
regex is not an "R" thing. Rather regular expressions
...
other tutorilas. Then you can refer to the help pages when necessary.
...
<em>
Compare this with `^SOME_PATTERN` which means, match the pattern that 
appears at the beginning of the text.
`^SOME_PATTERN` means that the the pattern must match at the beginning of
the entire character value.)
</em>
